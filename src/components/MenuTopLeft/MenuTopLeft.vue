...
export default {
  components: { AdminMenu, RelatoriosMenu, DashMenu, ActionMenu },
  nome: "MenuTopLeft",
  methods: {
    adminClicked(){
      console.log("\tactionClicked!!!\n")
      this.adminClass = !this.adminClass;
    },
    actionClicked(){
      console.log("\tactionClicked!!!\n")
    ...
    relatoriosClicked(){
      console.log("\tactionClicked!!!\n")
      this.relatoriosClass = !this.relatoriosClass;
    },
    dashClicked(){
      console.log("\tactionClicked!!!\n")
