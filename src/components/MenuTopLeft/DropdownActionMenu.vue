<template>
  ...
  >
    ...
    <div class="dropdown-item d-flex itens">
      ...
      <a class="ml-auto"><router-link v-if="userAccessPages[0].add" :to="{ name: 'RegistroMailing' }" @click.native.prevent="tellToColapse"><i class="fal fa-plus-circle"></i></router-link></a>
    </div>
      </router-link>
