  ...
  <div class="relatorios">
          ...
          <b-col cols="3">
            <div class="profile-content user-name-line d-flex">
              ...
              <div id="multiselect-input">
                <multiselect
                  v-model="tipo_humano"
                  :placeholder="'Tipo (Humano x Robô)'"
                  :label="'name'"
                  :track-by="'code'"
                  :options="humano_tipos"
                  :multiple="false"
                  ...
                  @select="setSelectedQType"
                  @remove="resetSelectedQType()"
                />
              </div>
            </div>
          </b-col>
        ...
        <b-row class="filas-top-section-row">
            ...
            <div class="profile-content user-name-line d-flex">
              ...
              <div id="multiselect-input">
                <multiselect
                  ...
                  :deselectLabel="MSprops.deselectLabel"
                  :deselectGroupLabel="MSprops.deselectGroupLabel"
                  @select="setSelectedFinalization"
                  @remove="resetSelectedFinalization()"
                />
              </div>
            </div>
          </b-col>
          ...
          <b-col cols="3">
            <div class="profile-content user-name-line d-flex">
              ...
              <div id="multiselect-input">
                <multiselect
                  v-model="tipo_recording"
                  :placeholder="'Formato Gravação'"
                  :label="'name'"
                  :track-by="'code'"
                  :options="recording_tipos"
                  :multiple="false"
                  :selectLabel="MSprops.selectLabel"
                  :selectGroupLabel="MSprops.selectGroupLabel"
                  :selectedLabel="MSprops.selectedLabel"
                  :deselectLabel="MSprops.deselectLabel"
                  :deselectGroupLabel="MSprops.deselectGroupLabel"
                  @select="setSelectedRecFormat"
                  @remove="resetSelectedRecFormat()"
                />
              </div>
            </div>
          </b-col>
          <b-col cols="3">
            <div class="profile-content user-name-line d-flex">
              ...
              <div id="multiselect-input">
                <multiselect
                  v-model="tipo_tipoSom"
                  :placeholder="'Tipo de Gravação'"
                  :label="'name'"
                  :track-by="'code'"
                  :options="tipoSom_tipos"
                  :multiple="false"
                  :selectLabel="MSprops.selectLabel"
                  :selectGroupLabel="MSprops.selectGroupLabel"
                  :selectedLabel="MSprops.selectedLabel"
                  :deselectLabel="MSprops.deselectLabel"
                  :deselectGroupLabel="MSprops.deselectGroupLabel"
                  @select="setSelectedRecType"
                  @remove="resetSelectedRecType()"
                />
              </div>
            </div>
          </b-col>
        ...
        <b-row class="filas-top-section-row2">
          <b-col cols="6">
            <div class="profile-content user-name-line d-flex">
              ...
              <b-form-input
                id="profile-name-input"
                type="number"
                placeholder="Tempo de Pós Atendimento (valor INTEIRO em segundos)"
                v-model="wrapuptime"
                @change="setWrapuptime"
              />
            </div>
          </b-col>
          ...
          <b-col cols="6">
            <div class="profile-content user-name-line d-flex">
              ...
              <div id="multiselect-input">
                <multiselect
                  v-model="tipo_pausegroup"
                  :placeholder="'Grupo de Pausas'"
                  :label="'name'"
                  :track-by="'code'"
                  :options="lista_de_grupos"
                  :multiple="false"
                  :selectLabel="MSprops.selectLabel"
                  :selectGroupLabel="MSprops.selectGroupLabel"
                  :selectedLabel="MSprops.selectedLabel"
                  :deselectLabel="MSprops.deselectLabel"
                  :deselectGroupLabel="MSprops.deselectGroupLabel"
                  @select="fillListaDePausas"
                  @remove="emptyListaDePausas()"
                />
              </div>
            </div>
          </b-col>
    ...
    <b-container fluid id="foundIt" v-if="dataOK">
      <b-tabs justified>
                  ...
                  <div class="profile-content user-name-line d-flex">
                    ...
                    <div id="multiselect-input">
                      <multiselect
                        ...
                        :deselectLabel="MSprops.deselectLabel"
                        :deselectGroupLabel="MSprops.deselectGroupLabel"
                        @select="setSelectedRoute"
                        @remove="resetSelectedRoute()"
                      />
                    </div>
                  </div>
                </b-col>
                ...
                <b-col cols="6">
                  <div class="profile-content user-name-line d-flex">
                    ...
                    <div id="multiselect-input">
                      <multiselect
                        v-model="tipo_strat"
                        :placeholder="'Estratégia de Discagem'"
                        :label="'name'"
                        :track-by="'name'"
                        :options="strat_tipos"
                        :multiple="false"
                        ...
                        :deselectLabel="MSprops.deselectLabel"
                        :deselectGroupLabel="MSprops.deselectGroupLabel"
                        @select="setSelectedStrategy"
                        @@remove="resetSelectedStrategy()"
                      />
                    </div>
                  </div>
                </b-col>
                  ...
                  <div class="profile-content user-name-line d-flex">
                    ...
                    <div id="multiselect-input">
                      <multiselect
                        ...
                        :deselectLabel="MSprops.deselectLabel"
                        :deselectGroupLabel="MSprops.deselectGroupLabel"
                        @select="setSelectedSpeed"
                        @remove="resetSelectedSpeed()"
                      />
                    </div>
                  </div>
                </b-col>
                  ...
                  <div class="profile-content user-name-line d-flex">
                    ...
                    <div id="multiselect-input">
                      <multiselect
                        ...
                        :deselectLabel="MSprops.deselectLabel"
                        :deselectGroupLabel="MSprops.deselectGroupLabel"
                        @select="setSelectedDialFormat"
                        @remove="resetSelectedDialFormat()"
                      />
                    </div>
                  </div>
                </b-col>
                ...
                <b-col cols="6">
                  <div class="profile-content user-name-line d-flex">
                    ...
                    <b-form-input
                      id="profile-name-input"
                      type="number"
                      placeholder="Tempo Limite de Conversação (valor INTEIRO em minutos)"
                      v-model="max_time_call"
                      @change="setMaxTimeCall"
                    />
                  </div>
                </b-col>
              </b-row>
              ...
              <b-row class="filas-top-section-row">
                <b-col cols="12">
                  <div class="profile-content user-name-line d-flex">
                    ...
                    <div id="multiselect-input">
                      <multiselect
                        v-model="tipo_blacklists"
                        :placeholder="'Blacklists'"
                        :label="'name'"
                        :track-by="'code'"
                        :options="blacklists_tipos"
                        :multiple="true"
                        :selectLabel="MSprops.selectLabel"
                        :selectGroupLabel="MSprops.selectGroupLabel"
                        :selectedLabel="MSprops.selectedLabel"
                        :deselectLabel="MSprops.deselectLabel"
                        :deselectGroupLabel="MSprops.deselectGroupLabel"
                        @select="setSelectedBlacklists"
                        @remove="resetSelectedBlacklists"
                      />
                    </div>
                  </div>
                </b-col>
                ...
                <b-col cols="6">
                  <div class="profile-content user-name-line2 d-flex">
                    ...
                    <b-form-input
                      ...
                      type="number"
                      placeholder="Número do Bina"
                      v-model="bina_number"
                      @change="setBinaNumber"
                    />
                    <b-form-checkbox
                      v-model="queue.flag_bina"
                      id="bina_switch"
                      switch
                    />
                  </div>
                ...
                <b-col cols="6">
                  <div class="profile-content user-name-line d-flex">
                    ...
                    <b-form-input
                      id="profile-name-input"
                      type="number"
                      placeholder="Tempo máximo de chamada (valor INTEIRO em segundos) - zero é sem limite"
                      v-model="maxlen"
                      @change="setMaxlen"
                    />
                  </div>
                ...
                <b-col cols="6">
                  <div class="profile-content user-name-line d-flex">
                    ...
                    <div id="multiselect-input">
                      <multiselect
                        v-model="tipo_peso"
                        :placeholder="'Peso da Fila - (1-2-3-4)'"
                        :label="'name'"
                        :track-by="'code'"
                        :options="peso_tipos"
                        :multiple="false"
                        ...
                        :deselectLabel="MSprops.deselectLabel"
                        :deselectGroupLabel="MSprops.deselectGroupLabel"
                        @select="setSelectedWeight"
                        @remove="resetSelectedWeight()"
                      />
                    </div>
                  </div>
                </b-col>
                  ...
                  <div class="profile-content user-name-line d-flex">
                    ...
                    <div id="multiselect-input">
                      <multiselect
                        ...
                        :deselectLabel="MSprops.deselectLabel"
                        :deselectGroupLabel="MSprops.deselectGroupLabel"
                        @select="setSelectedMusicOnHold"
                        @remove="resetSelectedMusicOnHold()"
                      />
                    </div>
                  </div>
                </b-col>
            ...
            <b-col cols="6">
              ...
              <b-container fluid v-for="(d, index) in week_days" :key="d.day">
                <b-row :class="index % 2 == 0 ? 'grey-bg' : ''">
                  <!-- Dias -->
                  <b-col cols="4" class="dia-body-container">
                    ...
                    <b-input-group class="input-group-sm">
                      ...
                      <b-input-group-append id="timepicker-append">
                        <b-form-timepicker
                          ...
                          size="sm"
                          :id="d.index + '_start_picker'"
                          v-model="start"
                          v-mask="timeMask"
                          :hour12="false"
                          @shown="start = d.start"
                          @hidden="d.start = start"
                        />
        ...
        <b-tab title="Pausas">
          <tabela-pausas
            :items="lista_de_pausas"
            :editable="false"
            class="tab-top-section-row"
            v-if="pausasOK"
          />
          <div
            v-else
            fluid
            class="container d-flex justify-content-around tab-top-section-row"
          >
          ...
          <b-container fluid>
            <b-col cols="12">
              ...
              <b-row class="tab-top-section-row">
                <b-col cols="12">
                  <tabela-agentes
                    :items="lista_de_agentes"
                    :filter="filtro_agentes"
                  />
                </b-col>
              </b-row>
    ...
    <b-container fluid class="salvar-container">
      <b-col cols="12">
        <b-row>
          <b-col cols="1">
            <b-button class="botao-salvar" @click="saveNewQueue()"
              >SALVAR</b-button
            >
          </b-col>
          <b-col cols="10" />
          <b-col cols="1">
            <label
              ><b-form-checkbox
                ...
                v-if="dataOK"
                id="status-button"
                ><span>Status</span></b-form-checkbox
              ></label
            >
          </b-col>
        </b-row>
...
export default {
  ...
  props: {
    nome: String,
    qID: { //ID da fila para ser passado de parâmetro
      type: Number,
      default: -1,
    },
  },
    ...
    return {
      status: true,
      dataOK: false, //quando se insere dados no formulário
      pausasOK: false, //quando se insere dados nos campos de pausa
      queue: null, //atributos das filas a serem criados e passados para a API
      pausa_loading_text:
        "Selecione um Grupo de Pausas para visualizar as Pausas pertencentes ao grupo.",
        //DADOS QUE MARCAMOS HORÁRIOS E SÃO PASSADOS PARA JSON
      start: "", 
      end: "",
      //-----------
      timeMask: "##:##",
      ...
      bina_number: "",
      filtro_agentes: "",
      MSprops: vueMultiselectProps, //LEGENADAS DOS MULTISELECTS
      queue_number: "", //CHAVE PRIMÁRIA
      name_queue: "",
      wrapuptime: "",
      max_time_call: "",
      maxlen: "",
      ...
      lista_de_pausas: null, // a ser preenchida (getBreakGroup())
      /* [ modelo
                {   
      ...
      /* [
            ...
            //Valores que serão opções nos MultiSelect's. Os que estão vazios serão preenchidos em métodos de GET
      tipo_fila: [],
      tipo_finish: [],
      tipo_recording: [],
      tipo_tipoSom: [],
  ...
  methods: {
    ...
    getDataItems() { //faz request e disponibiliza dados para o usuário
      ...
      axios
        ...
        .then((res) => {
          ...
          for (let i in a) {
            ...
            let name =
              a[i].name === a[i].agent.toString()
                ? a[i].name + " - " + a[i].type
                : a[i].agent.toString() + " - " + a[i].name;
            agente.agente = name;
            agente.p0 = false;
            agente.p1 = false;
            agente.p2 = false;
    ...
    checkForQID() { //se houver ID da fila, faz um get dela e disponibiliza seus dados para comparação. Se não, utiliza como parâmetro a fila default
      if (this.qID > 0) this.getQDataByID(this.qID);
      else this.getQDefaultData();
    },
    getQDefaultData() { //setta a fila default fazend um get sem ID como parâmetro e coloca no pausegroup 
      this.queue = { ...defaultQueue };
      this.getBreakGroups();
    },
    /* */ getQDataByID(id) {
      //Não finalizado. Falta concluir o set do objeto padrão de dados. [EDIÇÂO]
      let qid = id.toString();
      axios.get(baseApiUrl + "/queues/" + qid).then((res) => {
        console.log("Status:\t", res.status, " - ", res.statusText);
        let q = res.data.data;
        let queue = {};
    ...
    getBreaksFromGroup(id) {
      //passa para o parametro fields da tabela de pausas: o nome e o objeto group_breaks do primeiro resultado da query by id de acordo com o ID passado
      let gID = id.toString();
      axios.get(baseApiUrl + "/breaksGroups/" + gID).then((res) => {
        let g = res.data.data;
        let pausas = [];
        let first = {};
        let items = [];
        ...
        for (let j in g[0].group_breaks) {
          //percorre o breakGroup para enviar como um parâmetro depos de personalizar
          let pausa = {};
          ...
          pausa.alerta =
            g[0].group_breaks[j].time_alert === null
              ? ""
              : g[0].group_breaks[j].time_alert;
          pausa.limite =
            g[0].group_breaks[j].time_limit === null
              ? "00:01:00"
              : g[0].group_breaks[j].time_limit;
          let icon =
            typeof g[0].group_breaks[j].icone === "string"
              ? "<i class='" + g[0].group_breaks[j].icone + "'/>"
              : g[0].group_breaks[j].icone;
          pausa.icone = icon;
          pausa.icon_class =
            g[0].group_breaks[j].icone === null
              ? "fal fa-ad fa-2x"
              : g[0].group_breaks[j].icone;
        ...
        this.pausasOK = true; //atualiza a tabela
      });
    },
    fillListaDePausas(value) {
      //pega o valor selecionado e setta o tab-item de Pausas
      console.log(
        "Grupo de Pausas selecionado (valor):\t",
        value,
        "\tCódigo (group_id):",
        value.code
      );
    ...
    setSelectedBreakGroup(value) {
      //passa o valor selecionado pelo select pausegroup ao dado que será transformado em objeto
    ...
    setSlug(value) { //pega o valor do nome, retira espaço e adiciona no corpo que será postado em slug (FTP)
    ...
    resetSelectedBlacklists(value) {
      ...
      console.log(
        "New Blacklists @resetSelectedBlacklists:\n",
    ...
    saveNewQueue() { //valida todas as filas e POSTa no servidor
      ...
      if (blankQName || blankQNumber) {
        let toast = {
          ...
          message:
            "A Nova Fila não pôde ser criada. Não é permitido salvar uma Nova Fila com o Nome ou Número da Fila vazio ou apenas com espaços em branco.",
        };
        this.validateAndToast(toast);
        return;
      } else { //se as filas não estiverem vazias, cria o corpo do body e faz o POST
        let body = {};
        ...
        body.work_time = this.stringifyWorkTime(); //(com os horários em JSON)
        this.postNewQueue(body);
      }
    },
    stringifyWorkTime() { //retorna uma JSON com todos os horários criados pelo usuário
      let timetable = [];
      let day = { in: "", out: "" };
      for (let i = 0; i < 7; i++) {
        timetable.push({ ...day });
      ...
      for (let j in this.queue.work_time) {
        timetable[this.queue.work_time[j].index].in = this.queue.work_time[
          j
        ].start;
        timetable[this.queue.work_time[j].index].out = this.queue.work_time[
          j
        ].end;
      }
      return JSON.stringify(timetable);
    },
    postNewQueue(body) { //Posta a nova fila depois de validado
      console.log("Body @postNewQueue():\n", body);
      axios
        .post(baseApiUrl + "/queues", body)
        .then((res) => {
          console.log("Status:\t", res.status, " - ", res.statusText);
          let toast = {
            isValidated: true,
        ...
        .catch((error) => {
          ...
          let toast = {
            ...
            message:
              ...
              " não pôde ser adicionada. Motivo: " +
              error.message,
          };
          this.validateAndToast(toast);
        });
  ...
  created() {
    this.getDataItems(); //disponibiliza todos os dados para o usuário
